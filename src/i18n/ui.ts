...
export const ui = {
	...
	'tags.business.name': 'Business',
	'tags.business.slug': 'business',
	'tags.design.name': 'Design',
	'tags.design.slug': 'design',
	'tags.economy.name': 'Economy',
	'tags.economy.slug': 'economy',
	'tags.ethics.name': 'Ethics',
	'tags.ethics.slug': 'ethics',
	'tags.future.name': 'Future',
	'tags.future.slug': 'future',
	'tags.gaming.name': 'Gaming',
	'tags.gaming.slug': 'gaming',
	'tags.hardware.name': 'Hardware',
	'tags.hardware.slug': 'hardware',
	'tags.opinion.name': 'Opinion',
	'tags.opinion.slug': 'opinion',
	'tags.philosophy.name': 'Philosophy',
	'tags.philosophy.slug': 'philosophy',
	'tags.retro-tech.name': 'Retro Tech',
	'tags.retro-tech.slug': 'retro-tech',
	'tags.review.name': 'Review',
	'tags.review.slug': 'review',
...
export function getTag(key: string): { name: string; slug: string } {
	...
	const name = key.replace(/-/g, ' ').replace(/\b\w/g, (char) => char.toUpperCase())
